-- EduConnect local SQLite bootstrap
-- Run against backend/educonnect.db. Temporary password for all accounts:
-- EduConnect@2026!
...
INSERT OR IGNORE INTO users (number, name, role, password_hash) VALUES
